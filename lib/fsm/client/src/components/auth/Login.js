  ...
  render() {
    ...
    const outState = (
      <div className="outState">
        You must be logged in the ask a question. Login below or{" "}
    ...
    const inState = `You are currently logged in as ${user.name}.`;

    return <div className="Login">{isAuthenticated ? inState : outState}</div>;
  }
}
